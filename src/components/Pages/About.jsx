...
const About = () => {
    return (
        <div>
            <Helmet>
                <title>Roxsy - Hakkımda</title>
                <meta name="description" content="Web tabanlı uygulamalar geliştiriyor ve Discord botları ile ilgileniyorum. Portföyüm ve becerilerim için URL Roxsy adresini ziyaret edin." />
            ...
            <div className='mt-20'>
                ...
                <div className='py-0 px-0 sm:py-8 sm:px-20'>
                    <div className='flex gap-2 py-8 px-20'>
                        ...
                        <span className='font-bold text-2xl text-gray-300 sm:mt-2'>Roxsy kimdir?</span>
                    </div>
                    <div className='p-4 sm:p-1'>
                        <h2 className='text-lg text-gray-300 font-medium'>Merhaba, ben Roxsy!</h2>
                        <p className='text-gray-400 mt-1'>16 yaşında bir Full Stack Developer olarak, 4 yıldır yazılım dünyasına merak salmış, bu alanda kendimi geliştirmeye çalışan biriyim. Kayseri'de yaşıyorum ve aynı zamanda Youtube platformunda Discord botları ve yazılım ile ilgili videolar paylaşarak topluluğa katkıda bulunmaya çalışıyorum. Tüm bunlarla birlikte, lise eğitimimi sürdürürken yazılımla ilgili lisans eğitimi almayı hedefliyor ve bu alanda daha ileri düzeyde çalışmalar yapmak istiyorum.</p>
